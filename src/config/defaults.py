...
# Path to saving bins results file while doing 310-infer.
_C.TEST.SAVE_BINS_RESULTS_PATH = ""
# -----------------------------------------------------------------------------
# ResNet options
# -----------------------------------------------------------------------------
_C.RESNET = CfgNode()
...
_C.DATA.MAX_NUM_BOXES_PER_FRAME = 28
...
_C.DATA.TEST_SCALE_HEIGHT = 256
_C.DATA.TEST_SCALE_WIDTH = 384
...
_C.AVA.LABEL_MAP_FILE = "person_box_67091280_iou90/ava_action_list_v2.1_for_activitynet_2018.pbtxt"
...
# choosing a subset of activations outputted by a layer for visualization.
# If indexing is not specified, visualize all activations outputted by the layer.
...
# Threshold for uncommon class names. This will not be
