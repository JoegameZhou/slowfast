...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=get_path_on_modelart("../../configs/AVA/SLOWFAST_32x2_R50_SHORT_MODELARTS.yaml"),
        type=str,
    )
    parser.add_argument(
        "--device_target",
    ...
    parser.add_argument('--train_url',
                        ...
                        default='./model')
    # Define parameters for 310 infer.
    parser.add_argument('--src_bin_dir', type=str, help='')
...
def get_path_on_modelart(config_path):
    """
    Process path on model arts.
    """
