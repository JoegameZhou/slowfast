...
if [ $# != 4 ] ; then
    ...
    echo "sh scripts/run_standalone_eval.sh CFG DATA_DIR CHECKPOINT_FILE_PATH DEVICE_ID"
    echo "for example: sh scripts/run_standalone_eval.sh configs/AVA/SLOWFAST_32x2_R50_SHORT.yaml data/ava checkpoint_epoch_00020_best248.pyth.ckpt 1"
    echo "=============================================================================================================="
    exit 1;
fi
get_real_path(){
