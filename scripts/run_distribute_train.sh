...
echo "sh scripts/run_distribute_train.sh RANK_TABLE_FILE CFG DATA_DIR CHECKPOINT_FILE_PATH"
echo "for example: sh scripts/run_distribute_train.sh RANK_TABLE_FILE configs/AVA/SLOWFAST_32x2_R50_SHORT.yaml data/ava SLOWFAST_8x8_R50.pkl.ckpt"
echo "=============================================================================================================="
exit 1;
fi
if [ ! -f $1 ]
